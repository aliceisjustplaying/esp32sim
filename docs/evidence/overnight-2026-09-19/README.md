...
| Approximate-timing model, EX066 configuration | historical: 0.478× (Sep 7, d13b7f93) | 0.98–1.05× with measurement-informed instruction, alignment, data-cache and fetch-cache prices; 1.14× without the fetch cache (single untimed runs) | `night/timed-0919` at 47f3e2a8 |
