...
`/Users/alice/Archives/esp32s3/2026-09-01-tier-b-decomposition/canonical-7a157d4`.
...
```text
(cd /Users/alice/Archives/esp32s3/2026-09-01-tier-b-decomposition/canonical-7a157d4 && shasum -a 256 -c SHA256SUMS)
```
