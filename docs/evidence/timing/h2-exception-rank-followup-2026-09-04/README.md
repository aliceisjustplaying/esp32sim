...
```text
python3 docs/evidence/timing/h2-exception-rank-followup-2026-09-04/analyze.py > /Users/alice/tmp/h2-summary.json
diff -u docs/evidence/timing/h2-exception-rank-followup-2026-09-04/summary.json /Users/alice/tmp/h2-summary.json
```
