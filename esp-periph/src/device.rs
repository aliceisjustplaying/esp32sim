...
impl WriteEffect {
    ...
    pub fn contains(self, o: WriteEffect) -> bool {
        self.0 & o.0 != 0
    }
}
impl std::ops::BitOr for WriteEffect {
    type Output = WriteEffect;
    fn bitor(self, o: WriteEffect) -> WriteEffect {
        WriteEffect(self.0 | o.0)
    }
}
