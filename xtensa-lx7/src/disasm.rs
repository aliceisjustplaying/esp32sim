...
pub fn mnemonic(i: &Insn) -> String {
    ...
    match i.op {
        Rsr | Wsr | Xsr => match sr_name(i.imm as u32) {
            Some(n) => format!("{}.{}", base, n),
            None => format!("{}.{}", base, i.imm),
        },
        Rur | Wur => match ur_name(i.imm as u32) {
            Some(n) => format!("{}.{}", base, n),
            None => format!("{}.{}", base, i.imm),
        },
        _ => base.to_string(),
...
fn mac16_mnemonic(i: &Insn) -> String {
    ...
    match op2 {
        0 => format!("mula.dd.{}.ldinc", half),
        1 => format!("mula.dd.{}.lddec", half),
        2 => format!("{}.dd.{}", kind, half),
        3 => format!("{}.ad.{}", kind, half),
        4 => format!("mula.da.{}.ldinc", half),
        5 => format!("mula.da.{}.lddec", half),
        6 => format!("{}.da.{}", kind, half),
        7 => format!("{}.aa.{}", kind, half),
        8 => "ldinc".into(),
        9 => "lddec".into(),
        _ => "mac16.?".into(),
    }
...
pub fn operands(i: &Insn) -> Vec<String> {
    ...
    match i.op {
        Ill | IllN | Nop | NopN | Syscall | Simcall | Isync | Rsync | Esync | Dsync | Excw
        | Memw | Extw | Ret | RetN | Retw | RetwN | Rfe | Rfue | Rfde | Rfwo | Rfwu | Rfme => {
            vec![]
        }
        ...
        | Mul16u | Mul16s | Quou | Quos | Remu | Rems | Salt | Saltu => vec![a(r), a(s), a(t)],
        ...
        MovS | AbsS | NegS | Div0S | Nexp01S | Recip0S | Rsqrt0S | Sqrt0S | MksadjS | MkdadjS
        | AddexpS | AddexpmS => vec![f(r), f(s)],
