...
#[derive(Clone, Copy)]
struct Hot { epoch: u64, bloom: u64, slot: u32, k: u32, len: u32, lo: u32, span: u32, pages: [(u32, u32); 6], npages: u32, nsites: u32, sites: *const u32 }
impl Hot { const NONE: Hot = Hot { epoch: 0, bloom: 0, slot: 0, k: 0, len: 0, lo: 0, span: 0, pages: [(0, 0); 6], npages: 0, nsites: 0, sites: std::ptr::null() }; }
