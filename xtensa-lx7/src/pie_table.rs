// GENERATED by tools/gen_pie_table.py from the ESP32-S3 TRM (chapter 1, Instruction Word layouts). Do not edit.
use crate::pie::*;
...
pub static OPS: &[PieInsn] = &[
    ...
    PieInsn {
        ...
        fields: &[
            ...
            Field {
                role: Role::Imm,
                pieces: &[(7, 6, 24), (5, 2, 16), (0, 0, 8), (1, 1, 0)],
                signed: true,
                scale: 8,
            },
        ],
    ...
    PieInsn {
        ...
        kind: Kind::MovQacc { w: 8, signed: true },
    },
    PieInsn {
    ...
    PieInsn {
        ...
        fields: &[
            ...
            Field {
                role: Role::Imm,
                pieces: &[(7, 6, 24), (2, 2, 23), (5, 5, 19), (4, 3, 12), (1, 0, 8)],
                signed: true,
                scale: 16,
            },
            Field {
    ...
    PieInsn {
        ...
        kind: Kind::Vsmulas { w: 16, ld: false },
    },
    PieInsn {
        ...
        kind: Kind::Vsmulas { w: 16, ld: true },
    },
    PieInsn {
        ...
        fields: &[
            ...
            Field {
                role: Role::Sel,
                pieces: &[(3, 2, 20), (1, 1, 15), (0, 0, 4)],
                signed: false,
                scale: 1,
            },
        ],
        kind: Kind::Vsmulas { w: 8, ld: false },
    },
    PieInsn {
        ...
        fields: &[
            ...
            Field {
                role: Role::Sel,
                pieces: &[(0, 0, 20), (3, 1, 16)],
                signed: false,
                scale: 1,
            },
        ],
        kind: Kind::Vsmulas { w: 8, ld: true },
    },
    PieInsn {
        name: "ee.vsr.32",
        len: 3,
