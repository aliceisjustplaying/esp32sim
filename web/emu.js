...
(() => {
  ...
  panel.innerHTML = `<style>#fwpanel{margin:12px 18px 0;padding:12px 16px;background:#fff;border:1px solid #e5e7eb;border-radius:10px;font-size:13px}
    ...
    <div class="row">
      <label>board <select id="fw_board"><option>waveshare-lcd4b</option><option>atech14</option><option>waveshare-cam</option><option>none</option><option>esp32c3</option><option>esp32c6</option><option>waveshare-c6-lcd147</option></select></label>
