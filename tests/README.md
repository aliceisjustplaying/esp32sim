...
The **golden-output tests** (`cli/tests/goldens.rs`, `cli-c3/tests/goldens.rs`) are the
...
| `hello-c3.*` | the same on the ESP32-C3 (RISC-V), with the MAC/reset cause/straps of the real module in `hw/c3-hello-world-real.txt` |
